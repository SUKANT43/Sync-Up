...
async forgotPassword(@Body() body: ForgotPasswordBody) {
  try {
    ...
    await transporter.sendMail({
      from: `"${ENV.APP_NAME}" <${process.env.EMAIL_USER}>`,
      to: email,
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f8f8; border-radius: 5px;">
        <tr>
            <td style="padding: 20px;">
                ...
                <p style="font-size: 16px;">If the button doesn't work, copy this link:</p>
                ...
                <p style="font-size: 16px;">If you didn't request this, ignore this email.</p>
